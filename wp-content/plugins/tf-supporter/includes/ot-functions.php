...
if ( ! function_exists( 'ot_register_theme_options_admin_bar_menu' ) ) {
	...
	function ot_register_theme_options_admin_bar_menu( $wp_admin_bar ) {
		...
		$wp_admin_bar->add_node(
			array(
				'parent' => 'appearance',
				'id'     => apply_filters( 'ot_theme_options_menu_slug', 'themefood-options' ),
				'title'  => apply_filters( 'ot_theme_options_page_title', __( 'Themefood Options', 'option-tree' ) ),
				'href'   => admin_url( apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ) . '?page=' . apply_filters( 'ot_theme_options_menu_slug', 'themefood-options' ) ),
			)
		);
	}
}
