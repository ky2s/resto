...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function install_plugins_page() {
			...
			/*
			(function ($) {
				$.each($('table #the-list td.plugin > strong > a'), function(){
					if($(this).text().toLowerCase() === 'tf supporter'){
						$(this).parents('.plugin').find('.install a').attr('href',$(this).attr('href')).attr('target','_blank');
					}
				})
			})(jQuery);
			*/
